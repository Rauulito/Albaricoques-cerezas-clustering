...
#Definimos la cantidad de frutas que hay que generar
cantidadObservaciones = 2000

#Porbtanto vamos a definir 2000 cerezas y 2000 albaricoques
cerezas = []
random.seed()
...
#Finalmente, concatenamos las tablas de cerezas y de albaricoques y mezclamos el resultado
